...
| ----------------------------- | ---------------------------------- |
| Funktionalität der API        | 19 / 19                            |
| Persistenz über DB            | 6 / 6                             |
| Repository, Config und README | 5 / 5                             |
| **Summe**:                    | 30 / 30                            |
| **Bestanden**:                | ja                               |

## Funktionalität der API (19 / 19)
> Anforderungen für maximale Punktzahl: API hat alle geforderten Ressourcen (URLs plus Request und Response Bodies) mit korrekter Funktionalität, d.h., alle [automatisierten API-Tests](https://github.tik.uni-stuttgart.de/justus-bogner/pe2-ws21-api-tests-ex2) wurden bestanden.
...
- Suite `assignees.tests.js` (8,5 Punkte)
...
- Suite `todos.tests.js` (9,5 Punkte)
...
- [x] (3 Punkte) `todos` werden vollständig in einer DB-Tabelle persistiert
...
- [x] (0,5 Punkte) README der `api` enthält klare, IDE-unabhängige Anweisungen zur Ausführung der Applikation
