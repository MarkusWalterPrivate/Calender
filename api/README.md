...
- Set you email login data in the \src\main\resources\application.properties: `mail.username`, `mail.password`, `mail.address` must all valid data of the same account for the SMTP-Server of the University of Stuttgart
